...
// 1. In order to run this method, we need to call the initDriver method here. Remember that it is a static method, and we want to call it here (to a non-static method).
